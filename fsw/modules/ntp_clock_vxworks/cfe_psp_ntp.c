...
**         CFE_PSP_ERROR - If unsuccessfully started NTP Sync task
*/
...
/*
 ** Purpose: Check if CFS Time Service is up and running
 ** 
 ** Description:
 ...
 **
 ** See also CFE_PSP_TIME_NTPSync_Task
 **
 */
