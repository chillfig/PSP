...
const char CFE_MISSION_NAME[] = "PSP Functional Test";   /**< Name of CFE mission */
const char CFE_MISSION_CONFIG[] = "target"; /**< Configuration name used for build */
...
{ "MISSION", "git:rel_v2.0-241-g163be5c-dirty" },
{ "core_api", "git:draco-rc1-dirty" },
{ "core_private", "git:draco-rc1-dirty" },
{ "ci", "git:24f10b3" },
{ "to", "git:76a4234" },
{ "io_lib", "git:88299aa" },
{ "tte_lib", "git:v1.0.0.1-16-g0fea487" },
{ "tte_mgr", "git:v1.0.0.1-15-g99b65f4" },
{ "sch_tt", "git:v1.0.0.1-11-ge7fef8c" },
{ "sbng", "git:v2.0.0.1-36-g1dbb14e" },
{ "sbng_tte", "git:v2.0.0.1-36-g1dbb14e" },
{ "sbng_udp", "git:v2.0.0.1-36-g1dbb14e" },
{ "sbng_tcp", "git:v2.0.0.1-36-g1dbb14e" },
{ "vs", "git:5a8a39e" },
{ "cp", "git:cp-vsmfsw-v0.1.0.0-13-g7555bbc" },
{ "cf", "git:draco-eval1-10-gd0b3e25" },
{ "cs", "git:draco-eval1-12-g690d983" },
{ "ds", "git:draco-eval1-9-gd2dda7a" },
{ "fm", "git:draco-eval1-14-gdff3dcd" },
{ "hk", "git:draco-eval1-9-gdedeaee" },
{ "hs", "git:draco-eval1-17-g297395e" },
{ "lc", "git:draco-eval1-11-g3cb6f2f" },
{ "md", "git:draco-eval1-12-gb82f014" },
{ "mm", "git:draco-eval1-13-ge458e92" },
{ "sc", "git:draco-eval1-19-g5a439ee" },
{ "cfe_assert", "git:draco-rc1-dirty" },
{ "es", "git:draco-rc1-dirty" },
{ "evs", "git:draco-rc1-dirty" },
{ "fs", "git:draco-rc1-dirty" },
{ "sb", "git:draco-rc1-dirty" },
{ "tbl", "git:draco-rc1-dirty" },
{ "time", "git:draco-rc1-dirty" },
{ "osal", "git:draco-rc1" },
{ "psp", "git:sp0-vxworks6.9-v1.5.1.0-30-g589262e-dirty" },
{ "sbr", "git:draco-rc1-dirty" },
{ "resourceid", "git:draco-rc1-dirty" },
{ "config", "git:draco-rc1-dirty" },
{ "gateway_msg", "git:v1.0.0.1-12-g2af5b54" },
