...
void Ut_CFE_PSP_MemScrubSet(void)
{
    ...
    UtAssert_True(g_uiMemScrubStartAddr == startAdr, "_CFE_PSP_MemScrubSet - 1/10: Nominal - priority same - confirm start addr");
    UtAssert_True(g_uiMemScrubEndAddr == endAdr, "_CFE_PSP_MemScrubSet - 1/10: Nominal - priority same - confirm end addr");
    ...
    UtAssert_True(g_uiMemScrubStartAddr == startAdr, "_CFE_PSP_MemScrubSet - 2/10: Nominal - priority changed - confirm start addr");
    UtAssert_True(g_uiMemScrubEndAddr == endAdr, "_CFE_PSP_MemScrubSet - 2/10: Nominal - priority changed - confirm end addr");
    ...
    if (taskpriority > MEMSCRUB_PRIORITY_UP_RANGE)
    {
        UtAssert_True(g_uiMemScrubTaskPriority == MEMSCRUB_DEFAULT_PRIORITY,
            "_CFE_PSP_MemScrubSet - 3/7: Nominal - priority changed set to default");
    }
    UtAssert_True(g_uiMemScrubStartAddr == startAdr, "_CFE_PSP_MemScrubSet - 3/10: Nominal - priority changed max - confirm start addr");
    UtAssert_True(g_uiMemScrubEndAddr == endAdr, "_CFE_PSP_MemScrubSet - 3/10: Nominal - priority changed max - confirm end addr");
    ...
    UtAssert_True(g_uiMemScrubStartAddr == startAdr, "_CFE_PSP_MemScrubSet - 4/10: Nominal - priority changed min - confirm start addr");
    UtAssert_True(g_uiMemScrubEndAddr == endAdr, "_CFE_PSP_MemScrubSet - 4/10: Nominal - priority changed min - confirm end addr");
    ...
    UtAssert_True(g_uiMemScrubStartAddr == startAdr, "_CFE_PSP_MemScrubSet - 5/10: Nominal - top of RAM init - confirm start addr");
    UtAssert_True(g_uiMemScrubEndAddr == endAdr, "_CFE_PSP_MemScrubSet - 5/10: Nominal - top of RAM init - confirm end addr");
    ...
    UtAssert_True(g_uiMemScrubStartAddr == startAdr, "_CFE_PSP_MemScrubSet - 6/10: Nominal - start address too large - confirm start addr");
    UtAssert_True(g_uiMemScrubEndAddr == g_uiEndOfRam, "_CFE_PSP_MemScrubSet - 6/10: Nominal - end address changed to default");
...
void Ut_CFE_PSP_MemScrubStatus(void)
{
    ...
    UtAssert_True(mss_Status.uiMemScrubStartAddr == g_uiMemScrubStartAddr, "_CFE_PSP_MemScrubStatus - 1/1: Start address value test");
    UtAssert_True(mss_Status.uiMemScrubEndAddr == g_uiMemScrubEndAddr, "_CFE_PSP_MemScrubStatus - 1/1: End address value test");
    UtAssert_True(mss_Status.uiMemScrubCurrentPage == g_uiMemScrubCurrentPage, "_CFE_PSP_MemScrubStatus - 1/1: Current page value test");
    UtAssert_True(mss_Status.uiMemScrubTotalPages == g_uiMemScrubTotalPages, "_CFE_PSP_MemScrubStatus - 1/1: Total pages value test");
    UtAssert_True(mss_Status.opMemScrubTaskPriority == g_uiMemScrubTaskPriority, "_CFE_PSP_MemScrubStatus - 1/1: Task priority value test");
    ...
    UtAssert_True(mss_Status.uiMemScrubStartAddr == g_uiMemScrubStartAddr, "_CFE_PSP_MemScrubStatus - 2/2: Start address value test");
    UtAssert_True(mss_Status.uiMemScrubEndAddr == g_uiMemScrubEndAddr, "_CFE_PSP_MemScrubStatus - 2/2: End address value test");
    UtAssert_True(mss_Status.uiMemScrubCurrentPage == g_uiMemScrubCurrentPage, "_CFE_PSP_MemScrubStatus - 2/2: Current page value test");
    UtAssert_True(mss_Status.uiMemScrubTotalPages == g_uiMemScrubTotalPages, "_CFE_PSP_MemScrubStatus - 2/2: Total pages value test");
    UtAssert_True(mss_Status.opMemScrubTaskPriority == g_uiMemScrubTaskPriority, "_CFE_PSP_MemScrubStatus - 2/2: Task priority value test");
}
/*=======================================================================================
...
void Ut_CFE_PSP_MemScrubDisable(void)
{
    ...
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDisable - 1/5: Memory scrub total pages reset");
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED,"_CFE_PSP_MemScrubDisable - 1/5: Memory scrub task ID reset"); */
    ...
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDisable - 2/5: Memory scrub total pages reset");
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED,"_CFE_PSP_MemScrubDisable - 2/5: Memory scrub task ID reset"); */
    ...
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDisable - 3/5: Memory scrub total pages reset");
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED,"_CFE_PSP_MemScrubDisable - 3/5: Memory scrub task ID reset"); */
    ...
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDisable - 4/5: Memory scrub total pages reset");
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED,"_CFE_PSP_MemScrubDisable - 4/5: Memory scrub task ID reset"); */
    ...
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDisable - 5/5: Memory scrub total pages reset");
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED,"_CFE_PSP_MemScrubDisable - 5/5: Memory scrub task ID reset"); */
}
...
void Ut_CFE_PSP_MemScrubDelete(void)
{
    ...
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED, "_CFE_PSP_MemScrubDelete - 2/4: Mem scrub task id reset"); */
    UtAssert_True(g_uiMemScrubCurrentPage == 0, "_CFE_PSP_MemScrubDelete - 2/4: Mem scrub current page reset");
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDelete - 2/4: Mem scrub total pages reset");
    UtAssert_True(g_uiMemScrubStartAddr == 0, "_CFE_PSP_MemScrubDelete - 2/4: Mem scrub start address reset");
    UtAssert_True(g_uiMemScrubEndAddr == g_uiEndOfRam, "_CFE_PSP_MemScrubDelete - 2/4: Mem scrub end address reset");
    UtAssert_True(g_uiMemScrubTaskPriority == MEMSCRUB_DEFAULT_PRIORITY, "_CFE_PSP_MemScrubDelete - 2/4: Mem scrub task priority reset");
    ...
    /* UtAssert_True(g_uiMemScrubTaskId == OS_OBJECT_ID_UNDEFINED, "_CFE_PSP_MemScrubDelete - 3/4: Mem scrub task id reset"); */
    UtAssert_True(g_uiMemScrubCurrentPage == 0, "_CFE_PSP_MemScrubDelete - 3/4: Mem scrub current page reset");
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDelete - 3/4: Mem scrub total pages reset");
    UtAssert_True(g_uiMemScrubStartAddr == 0, "_CFE_PSP_MemScrubDelete - 3/4: Mem scrub start address reset");
    UtAssert_True(g_uiMemScrubEndAddr == g_uiEndOfRam, "_CFE_PSP_MemScrubDelete - 3/4: Mem scrub end address reset");
    UtAssert_True(g_uiMemScrubTaskPriority == MEMSCRUB_DEFAULT_PRIORITY, "_CFE_PSP_MemScrubDelete - 3/4: Mem scrub task priority reset");
    ...
    /* UtAssert_True(g_uiMemScrubTaskId OS_OBJECT_ID_UNDEFINED, "_CFE_PSP_MemScrubDelete - 4/4: Mem scrub task id reset"); */
    UtAssert_True(g_uiMemScrubCurrentPage == 0, "_CFE_PSP_MemScrubDelete - 4/4: Mem scrub current page reset");
    UtAssert_True(g_uiMemScrubTotalPages == 0, "_CFE_PSP_MemScrubDelete - 4/4: Mem scrub total pages reset");
    UtAssert_True(g_uiMemScrubStartAddr == 0, "_CFE_PSP_MemScrubDelete - 4/4: Mem scrub start address reset");
    UtAssert_True(g_uiMemScrubEndAddr == g_uiEndOfRam, "_CFE_PSP_MemScrubDelete - 4/4: Mem scrub end address reset");
    UtAssert_True(g_uiMemScrubTaskPriority == MEMSCRUB_DEFAULT_PRIORITY, "_CFE_PSP_MemScrubDelete - 4/4: Mem scrub task priority reset");
}
