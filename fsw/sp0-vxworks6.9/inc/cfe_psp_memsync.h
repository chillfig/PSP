...
*
*   \brief API header for controlling memory sync to file system
*
*   \brief This file contains the function prototypes that synchronize data in RAM/memory to a specific 
*   file on filesystem. 
*
*   \copyright
