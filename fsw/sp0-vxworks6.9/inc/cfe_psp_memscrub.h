...
*
*   \brief API header for controlling memory scrubbing
*
*   \brief This file contains the function prototypes relating to memory scrubbing. This is specific to 
*   the SP0-S processor running VxWorks 6.9 OS.
*
*   \copyright
