...
*   of the Gateway MOUs and IA requires prior U.S. Government authorization.\file
*
...
/*
** DEFINES that we are missing due to
** unavailable headerfiles
*/
typedef struct
{
...
#define TASK_ID                     int32   /* "int" Verified */
#define UINT32                      uint32  /* Probably */
#define UINT64                      uint64  /* Probably */
...
/**
** \brief Stubbed SPE_CONTEXT
**
** \par Description:
** Stubbed version of SPE_CONTEXT
**
** \par Assumptions, External Events, and Notes:
** Psuedo-accurate representation of actual SPE_CONTEXT implementation
*/
typedef struct
{
    UINT32 gpr[100]; 
 ...
 **
 ** \par Assumptions, External Events, and Notes:
 ** Psuedo-accurate representation of actual ESFPPC implementation
 */
typedef struct
{
    UINT32	spCopy;		    /* unused - redundant copy of regSet.gpr[1] */ 
...
/**
 ** \brief USER_SAFE_MODE_DATA_STRUCT Stub
 **
 ** \par Description
 ** USER_SAFE_MODE_DATA_STRUCT Stub
 **
 ** \par Assumptions, External Events, and Notes:
 ** Psuedo-accurate representation of actual USER_SAFE_MODE_DATA_STRUCT implementation
 */
typedef struct
{
    uint32 safeMode;    /* 1 = current reset is due to safe mode reset, 0 = normal POR */
    uint32 sbc;         /* location of SBC caused safe mode reset if occurred */
    uint32 reason;      /* reson of safe mode reset if occurred */
