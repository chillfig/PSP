...
void Test_CFE_PSP_edrPolicyHandlerHook(void)
{
    ...
    g_pDefaultedrPolicyHandlerHook = &PCS_currentedrPolicyHandlerHook1;
...
void Test_CFE_PSP_ExceptionGetSummary_Impl(void)
{
    ...
    char    tName[] = "NULL";
    char    tName_too_long[] = "NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL_NULL";
