...
void Test_CFE_PSP_StartNTPDaemon(void)
{
    ...
    UtAssert_True(return_code == IPCOM_SUCCESS, "_CFE_PSP_StartNTPDaemon - 2/5: NTP Daemon started succesfully, taskNameToId failure, correct return code");
    ...
    UtAssert_True(return_code == IPCOM_ERR_ALREADY_STARTED, "_CFE_PSP_StartNTPDaemon - 4/5: NTP Daemon started succesffully, taskNameToId failure, correct return code");
