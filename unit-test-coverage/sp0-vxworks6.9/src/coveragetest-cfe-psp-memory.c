...
extern uint32 g_uiMemorySyncStartup;
extern uint32 g_uiTotalReservedAllocSize;
extern char g_RESETFilepath[CFE_PSP_FILEPATH_MAX_LENGTH];
extern char g_CDSFilepath[CFE_PSP_FILEPATH_MAX_LENGTH];
extern char g_VOLATILEDISKFilepath[CFE_PSP_FILEPATH_MAX_LENGTH];
extern char g_USERRESERVEDFilepath[CFE_PSP_FILEPATH_MAX_LENGTH];
extern osal_id_t g_MemorySyncTaskBinSem;
extern osal_id_t g_uiMemorySyncTaskId;
extern osal_priority_t g_uiMemorySyncTaskPriority;
extern uint32 g_uiMemorySyncTime;
extern uint32 g_uiMemorySyncStatistics;
extern bool g_bCDSSyncFlag;

extern void CFE_PSP_MemSyncTask(void);
extern uint32 CFE_PSP_CalculateCRC(const void *DataPtr, uint32 DataLength, uint32 InputCRC);
extern int32 CFE_PSP_GetMemSize(uint32 *p_size, int op);
extern int32 CFE_PSP_GetMemArea(cpuaddr *p_area, uint32 *p_size, int op);
extern int32 CFE_PSP_ReadFromRAM(const void *p_data, uint32 offset, uint32 size, int op);
extern int32 CFE_PSP_WriteToRAM(const void *p_data, uint32 offset, uint32 size, int op);
extern int32 CFE_PSP_RestoreReset(void);
extern int32 CFE_PSP_RestoreCDS(void);
extern int32 CFE_PSP_RestoreVolatileDisk(void);
extern int32 CFE_PSP_RestoreUserReserved(void);
extern int32 CFE_PSP_RestoreData(int op);
extern int32 CFE_PSP_CDSFilepath(void);
extern int32 CFE_PSP_ResetFilepath(void);
extern int32 CFE_PSP_VolatileDiskFilepath(void);
extern int32 CFE_PSP_UserReservedFilepath(void);
extern int32 CFE_PSP_BootRecordFilepath(void);
extern int32 CFE_PSP_ExceptionStorageFilepath(void);
extern int32 CFE_PSP_GenerateFilepath(int op);
...
extern CFE_PSP_MemoryBlock_t SP0_ReservedMemBlock;
extern int PCS_OS_BSPMain(void);
extern int32 PCS_CFE_PSP_MemRangeSet(uint32 RangeNum, uint32 MemoryType, cpuaddr StartAddr, size_t Size, size_t WordSize, uint32 Attributes);
...
void Test_CFE_PSP_GetResetArea(void)
{
    ...
    /* Execute test */
    uiRetCode = CFE_PSP_GetResetArea((cpuaddr *)puiBlockAddress, puiBlockSize);
    /* Verify outputs */
    UtAssert_IntegerCmpAbs((cpuaddr)uiBlockAddress, (cpuaddr)CFE_PSP_ReservedMemoryMap.ResetMemory.BlockPtr, 0, 
...
void Test_CFE_PSP_GetUserReservedArea(void)
{
    ...
    /* Execute test */
    uiRetCode = CFE_PSP_GetUserReservedArea((cpuaddr *)puiUserArea, puiUserAreaSize);
    /* Verify outputs */
    UtAssert_IntegerCmpAbs((cpuaddr)uiUserArea, (cpuaddr)CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockPtr, 0, 
...
void Test_CFE_PSP_GetVolatileDiskMem(void)
{
    ...
    /* Execute test */
    uiRetCode = CFE_PSP_GetVolatileDiskMem((cpuaddr *)puiVolDisk, puiVolDiskSize);
    /* Verify outputs */
    UtAssert_IntegerCmpAbs((cpuaddr)uiVolDisk, (cpuaddr)CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockPtr, 0, 
...
void Test_CFE_PSP_InitProcessorReservedMemory(void)
{
    ...
    /** To avoid segfault **/
    uint32  buf_data_size = sizeof(CFE_PSP_ReservedMemoryBootRecord_t);
    uint8   localBuffer[buf_data_size];
    memset(localBuffer, 0x00, buf_data_size);
    CFE_PSP_ReservedMemoryMap.BootPtr = (void*)localBuffer;
    ...
    snprintf(cMsg, sizeof(cMsg), "CFE_PSP: VxWorks Reserved Memory Block Size not large enough, "
                  "Total Size = 0x%lx, "
    ...
    /* Verify results */
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 1/10: Invalid Block Size message");
    UtAssert_True(iReturnCode == CFE_PSP_ERROR, "_CFE_PSP_InitProcessorReservedMemory 1/10: Invalid Block Size return code");
    ...
    /* Verify results */
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 2/10: Not processor reset - return code");
    UtAssert_True(CFE_PSP_ReservedMemoryMap.BootPtr->bsp_reset_type == CFE_PSP_RST_TYPE_PROCESSOR, "_CFE_PSP_InitProcessorReservedMemory 2/10: Not processor reset - boot reset type check");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.CDSMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 2/10: CDS Block Check ");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.ResetMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.ResetMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 2/10: Reset Block Check");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 2/10: Volatile Disk Block Check");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 2/10: User Reserved Block Check");
    ...
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 3/10: Not processor reset - return code");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.ResetMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.ResetMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 3/10: Reset Block Check");

    /* ----- Test case #4 - Nominal with g_uiMemorySyncStartup True - CFE_PSP_RestoreReset ERROR ----- */
    /* Set additional inputs */
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    UT_SetDefaultReturnValue(UT_KEY(userReservedGet), URM_SIZE);
    ...
    memset(CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockPtr, 1, CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockSize);
    CFE_PSP_ReservedMemoryMap.BootPtr->bsp_reset_type = CFE_PSP_RST_TYPE_MAX;
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 5, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_creat), 1, PCS_ERROR);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "CFE_PSP_InitProcessorReservedMemory: Failed to restore Reset data\n");
    /* Execute test */
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 4/10: Print check");
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 4/10: Not processor reset - return code");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.CDSMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 4/10: CDS Block Check ");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.ResetMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.ResetMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 4/10: Reset Block Check");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 4/10: Volatile Disk Block Check");
    UtAssert_MemCmp(CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockPtr, uiZEROBuf, CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockSize, "_CFE_PSP_InitProcessorReservedMemory 4/10: User Reserved Block Check");
    ...
    /** For CFE_PSP_LoadNVRAM **/
    UT_SetDefaultReturnValue(UT_KEY(PCS_open), OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_read), 1, sizeof(CFE_PSP_ReservedMemoryBootRecord_t));
    UT_SetDeferredRetcode(UT_KEY(PCS_read), 1, sizeof(CFE_PSP_ExceptionStorage_t));
    ...
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 5/10: Load from flash success");
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "URM Data Recovered (%d bytes) - 0 new exception(s)\n", urm_data_size);
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 5/10: Load from flash success");
    ...
    Ut_OS_printf_Setup();
    g_uiMemorySyncStartup = true;
    UT_SetDefaultReturnValue(UT_KEY(PCS_stat), 0);
    UT_SetDefaultReturnValue(UT_KEY(PCS_open), OS_ERROR);
    UT_SetDefaultReturnValue(UT_KEY(userReservedGet), URM_SIZE);
    UT_SetDefaultReturnValue(UT_KEY(PCS_creat), 0);
    UT_SetDefaultReturnValue(UT_KEY(PCS_read), -1);
    /* Setting WriteToFlash == True */
    UT_SetDefaultReturnValue(UT_KEY(PCS_open), 0);
    UT_SetDefaultReturnValue(UT_KEY(PCS_write), CFE_PSP_ReservedMemoryMap.ResetMemory.BlockSize);
    UT_SetDefaultReturnValue(UT_KEY(PCS_close), OS_ERROR);
    memset(g_RESETFilepath, '\0', sizeof(g_RESETFilepath));
    memset(g_CDSFilepath, '\0', sizeof(g_CDSFilepath));
    memset(g_VOLATILEDISKFilepath, '\0', sizeof(g_VOLATILEDISKFilepath));
    memset(g_USERRESERVEDFilepath, '\0', sizeof(g_USERRESERVEDFilepath));
    CFE_PSP_ReservedMemoryMap.BootPtr->bsp_reset_type = CFE_PSP_RST_TYPE_MAX;
    /* Execute test */
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 6/10: Reset Memory Success");
    snprintf(cMsg, sizeof(cMsg), "PSP FLASH: FILE: <%s>\n", g_RESETFilepath);
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 6/10: Restore Reset Success");
    snprintf(cMsg, sizeof(cMsg), "PSP FLASH: FILE: <%s>\n", g_CDSFilepath);
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 6/10: Restore CDS Success");
    snprintf(cMsg, sizeof(cMsg), "PSP FLASH: FILE: <%s>\n", g_USERRESERVEDFilepath);
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 6/10: Restore User Reserved Success");
    ...
    /* Setting WriteToFlash == True */
    UT_SetDefaultReturnValue(UT_KEY(PCS_open), 0);
    UT_SetDefaultReturnValue(UT_KEY(PCS_write), CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockSize);
    UT_SetDefaultReturnValue(UT_KEY(PCS_close), OS_ERROR);
    memset(g_RESETFilepath, '\0', sizeof(g_RESETFilepath));
    memset(g_CDSFilepath, '\0', sizeof(g_CDSFilepath));
    memset(g_VOLATILEDISKFilepath, '\0', sizeof(g_VOLATILEDISKFilepath));
    ...
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 7/10: Reset Memory Success");
    snprintf(cMsg, sizeof(cMsg), "PSP FLASH: FILE: <%s>\n", g_VOLATILEDISKFilepath);
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 7/10: Restore Volatile Disk Success"); 
    snprintf(cMsg, sizeof(cMsg), "PSP FLASH: WriteToFLASH: Unable to close file\n");
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 7/10: Restore Volatile Disk WriteToFlash Close"); 

    /* ----- Test case #8 - Nominal with g_uiMemorySyncStartup True - CFE_PSP_RestoreCDS ERROR ----- */
    /* Set additional inputs */
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    UT_SetDefaultReturnValue(UT_KEY(userReservedGet), URM_SIZE);
    CFE_PSP_ReservedMemoryMap.BootPtr->bsp_reset_type = CFE_PSP_RST_TYPE_MAX;
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 7, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_creat), 1, PCS_ERROR);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "CFE_PSP_InitProcessorReservedMemory: Failed to restore CDS data\n");
    /* Execute test */
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 8/10: restore CDS fail - Print check");
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 8/10: restore CDS fail - return code");

    /* ----- Test case #9 - Nominal with g_uiMemorySyncStartup True - CFE_PSP_RestoreVolatileDisk ERROR ----- */
    /* Set additional inputs */
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    UT_SetDefaultReturnValue(UT_KEY(userReservedGet), URM_SIZE);
    CFE_PSP_ReservedMemoryMap.BootPtr->bsp_reset_type = CFE_PSP_RST_TYPE_MAX;
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 9, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_creat), 1, PCS_ERROR);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "CFE_PSP_InitProcessorReservedMemory: Failed to restore Volatile Disk data\n");
    /* Execute test */
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 9/10: restore vol disk fail - Print check");
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 9/10: restore vol disk fail - return code");

    /* ----- Test case #10 - Nominal with g_uiMemorySyncStartup True - CFE_PSP_RestoreUserReserved ERROR ----- */
    /* Set additional inputs */
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    UT_SetDefaultReturnValue(UT_KEY(userReservedGet), URM_SIZE);
    CFE_PSP_ReservedMemoryMap.BootPtr->bsp_reset_type = CFE_PSP_RST_TYPE_MAX;
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 11, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, PCS_ERROR);
    UT_SetDeferredRetcode(UT_KEY(PCS_creat), 1, PCS_ERROR);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "CFE_PSP_InitProcessorReservedMemory: Failed to restore User Reserved data\n");
    /* Execute test */
    iReturnCode = CFE_PSP_InitProcessorReservedMemory(CFE_PSP_RST_TYPE_PROCESSOR);
    /* Verify results */
    UtAssert_OS_print(cMsg, "_CFE_PSP_InitProcessorReservedMemory 10/10: restore user rsvp fail - Print check");
    UtAssert_True(iReturnCode == CFE_PSP_SUCCESS, "_CFE_PSP_InitProcessorReservedMemory 10/10: restore user rsvp fail - return code");
...
void Test_CFE_PSP_SetupReservedMemoryMap(void)
{
    ...
    /* Reset URM Allocations */
    pEndOfURM = UserReservedMemory;
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "SetupReservedMemory: MemRangeSet failed\n");
    UT_SetDefaultReturnValue(UT_KEY(userReservedGet), URM_SIZE);
    UT_SetDeferredRetcode(UT_KEY(PCS_CFE_PSP_MemRangeSet), 1, CFE_PSP_ERROR);
    /* Execute test */
    CFE_PSP_SetupReservedMemoryMap();
    /* Verify results */
    ...
    CFE_PSP_SetupReservedMemoryMap();
    /* Verify results */
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE \
...
{
    uint32  uiRetCode = 0;
    cpuaddr uiKernelSegment = 0;
    uint32  uiKernelSegmentSize = 0;
    cpuaddr *puiKernelSegment = NULL;
    ...
    /* Execute test */
    uiRetCode = CFE_PSP_GetKernelTextSegmentInfo((cpuaddr *)puiKernelSegment, puiKernelSegmentSize);
    /* Verify outputs */
...
void Test_CFE_PSP_GetCFETextSegmentInfo(void)
{
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_SymbolLookup), OS_ERROR);
    UT_SetDefaultReturnValue(UT_KEY(PCS_moduleFindByName), PCS_ERROR);
    /* Execute test */
    uiRetCode = CFE_PSP_GetCFETextSegmentInfo(pCFESegment, puiSizeOfCFESegment);
    /* Verify outputs */
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_SymbolLookup), OS_SUCCESS);
    UT_SetDataBuffer(UT_KEY(OS_SymbolLookup), &GetModuleIdAddr, sizeof(GetModuleIdAddr), false);
    UT_SetDefaultReturnValue(UT_KEY(PCS_moduleFindByName), 0);
    UT_SetDataBuffer(UT_KEY(moduleFindByName), &moduleInfo, sizeof(&moduleInfo), false);
    UT_SetDefaultReturnValue(UT_KEY(moduleInfoGet), OK);
    UT_SetDataBuffer(UT_KEY(moduleInfoGet), &moduleInfo, sizeof(&moduleInfo), false);
    /* Execute test */
...
void Test_CFE_PSP_GetMemSize(void)
{
    ...
    UT_ResetState(0);
    /* Execute test */
    iReturnCode = CFE_PSP_GetMemSize(&uiSize, 0);
    /* Verify results */
...
void Test_CFE_PSP_GetMemArea(void)
{
    ...
    UT_ResetState(0);
    /* Execute test */
    iReturnCode = CFE_PSP_GetMemArea((cpuaddr *)&uiLocalBlockPtr, &uiSize, 0);
    /* Verify results */
    ...
    UtAssert_IntegerCmpAbs((cpuaddr)uiLocalBlockPtr, (cpuaddr)CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr, 0, "_CFE_PSP_GetMemArea - 3/3: Got memory area ptr - value check"); 
}
...
void Test_CFE_PSP_GetCDSArea(void)
{
    ...
    /* Verify outputs */
    UtAssert_IntegerCmpAbs((cpuaddr)uiBlockAddress, (cpuaddr)CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr, 0,
...
void Test_CFE_PSP_RestoreReset(void)
{
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_creat), 1, 99);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_write), 1, CFE_PSP_ReservedMemoryMap.ResetMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreReset();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_read), 1, CFE_PSP_ReservedMemoryMap.ResetMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreReset();
    /* Verify results */
...
void Test_CFE_PSP_RestoreCDS(void)
{
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_write), 1, CFE_PSP_ReservedMemoryMap.CDSMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreCDS();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, 0);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, 99);
    UT_SetDeferredRetcode(UT_KEY(PCS_read), 1, CFE_PSP_ReservedMemoryMap.CDSMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreCDS();
    /* Verify results */
...
void Test_CFE_PSP_RestoreVolatileDisk(void)
{
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_write), 1, CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreVolatileDisk();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, 0);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, 99);
    UT_SetDeferredRetcode(UT_KEY(PCS_read), 1, CFE_PSP_ReservedMemoryMap.VolatileDiskMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreVolatileDisk();
    /* Verify results */
...
void Test_CFE_PSP_RestoreUserReserved(void)
{
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(PCS_write), 1, CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreUserReserved();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_stat), 1, 0);
    UT_SetDeferredRetcode(UT_KEY(PCS_open), 1, 99);
    UT_SetDeferredRetcode(UT_KEY(PCS_read), 1, CFE_PSP_ReservedMemoryMap.UserReservedMemory.BlockSize);
    UT_SetDeferredRetcode(UT_KEY(PCS_close), 1, OS_SUCCESS);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreUserReserved();
    /* Verify results */
...
void Test_CFE_PSP_WriteToRAM(void)
{
    ...
    /* Execute test */
    iReturnCode = CFE_PSP_WriteToRAM(NULL, uiCDSOffset, uiNumBytes, 0);
    /* Verify results */
    ...
    /* Execute test */
    iReturnCode = CFE_PSP_WriteToRAM(pucData, uiCDSOffset, uiNumBytes, 0);
    /* Verify results */
    ...
    CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr = (void*)localCDSBuffer;
    /* Execute test */
    iReturnCode = CFE_PSP_WriteToRAM(pucData, CFE_PSP_ReservedMemoryMap.CDSMemory.BlockSize + 99, uiNumBytes, 0);
    /* Verify results */
    ...
    (void)CFE_PSP_CalculateCRC(localCDSBuffer, 200, 0);
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "WriteToRAM: Failed to take bin sem, status: %d\n", OS_SEM_FAILURE);
    /* Execute test */
    iReturnCode = CFE_PSP_WriteToRAM(pucData, uiCDSOffset, uiNumBytes, 0);
    /* Verify results */
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "WriteToRAM: Fail to give bin sem, status %d\n", OS_SEM_FAILURE);
    /* Execute test */
    iReturnCode = CFE_PSP_WriteToRAM(pucData, uiCDSOffset, uiNumBytes, 0);
    /* Verify results */
...
void Test_CFE_PSP_ReadFromRAM(void)
{
    ...
    /* Execute test */
    iReturnCode = CFE_PSP_ReadFromRAM(NULL, uiCDSOffset, uiNumBytes, 0);
    /* Verify results */
    ...
    CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr = NULL;
    /* Execute test */
    iReturnCode = CFE_PSP_ReadFromRAM(pucData, uiCDSOffset, uiNumBytes, 0);
    /* Verify results */
    ...
    CFE_PSP_ReservedMemoryMap.CDSMemory.BlockPtr = (void*)localCDSBuffer;
    /* Execute test */
    iReturnCode = CFE_PSP_ReadFromRAM(pucData, CFE_PSP_ReservedMemoryMap.CDSMemory.BlockSize + 999, uiNumBytes, 0);
    /* Verify results */
...
void Test_CFE_PSP_RestoreData(void)
{
    ...
    /* Set additional inputs */
    Ut_OS_printf_Setup();
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_PRINT_SCOPE "RestoreData: Invalid Memory Option\n");
    /* Execute test */
    ...
    UT_SetDeferredRetcode(UT_KEY(PCS_creat), 1, -1);
    /* Execute test */
    iReturnCode = CFE_PSP_RestoreData(1);
    /* Verify results */
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncInit(void); Testcases
 *********************************************************/
void Test_CFE_PSP_MemSyncInit(void)
{
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Init: Failed to start task\n");
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncInit();
    /* Verify results */
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncDestroy(void); Testcases
 *********************************************************/
void Test_CFE_PSP_MemSyncDestroy(void)
{
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Destroy: Unable to kill MEMORY SYNC task\n");
    /* Execute tests */
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_TaskGetIdByName), 1, OS_ERR_NAME_NOT_FOUND);
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Destroy: Semaphore Error, status: %d\n", OS_SEM_FAILURE);
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncDestroy();
    /* Verify results */
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncStart(void); Testcases
 *********************************************************/
void Test_CFE_PSP_MemSyncStart(void)
{
    ...
    Ut_OS_printf_Setup();
    UT_SetDeferredRetcode(UT_KEY(OS_TaskGetIdByName), 1, 99);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Task already running\n");
    /* Execute tests */
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_TaskGetIdByName), 1, OS_ERR_NAME_NOT_FOUND);
    g_MemorySyncTaskBinSem = OS_OBJECT_ID_UNDEFINED;
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Start: Data not initialized\n");
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncStart();
    /* Verify results */
    ...
    g_MemorySyncTaskBinSem = OS_ObjectIdFromInteger(10);
    UT_SetDeferredRetcode(UT_KEY(OS_TaskCreate), 1, OS_ERROR);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Error starting MEMORY SYNC task\n");
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncStart();
    /* Verify results */
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncStop(void); Testcases
 *********************************************************/
void Test_CFE_PSP_MemSyncStop(void)
{
    ...
    Ut_OS_printf_Setup();
    UT_SetDeferredRetcode(UT_KEY(OS_TaskGetIdByName), 1, OS_ERR_NAME_NOT_FOUND);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Stop: Task not running\n");
    /* Execute tests */
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_TaskGetIdByName), 1, 99);
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Stop: Failed to take bsem, status: %d\n", OS_SEM_FAILURE);
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncStop();
    /* Verify results */
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Stop: Unable to delete task, status: %d\n", OS_ERROR);
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncStop();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemGive), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Stop: Failed to give bsem, status: %d\n", OS_SEM_FAILURE);
    OS_TaskCreate(
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncIsRunning(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncSetPriority(void); Testcases
 *********************************************************/
void Test_CFE_PSP_MemSyncSetPriority(void)
{
    ...
    /* Set additional inputs */
    Ut_OS_printf_Setup();
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "setPriority: New priority too high\n");
    newPriority = 250;
    /* Execute tests */
    ...
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "setPriority: New priority too low\n");
    newPriority = 1;
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncSetPriority(newPriority);
    /* Verify results */
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "setPriority: Failed to set new priority\n");
    /* Execute tests */
    iReturnCode = CFE_PSP_MemSyncSetPriority(newPriority);
    /* Verify results */
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncGetPriority(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncSetFrequency(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncGetFrequency(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncgetStatus(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_MemSyncTask(void); Testcases
 *********************************************************/
void Test_CFE_PSP_MemSyncTask(void)
{
    ...
    Ut_OS_printf_Setup();
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Task: Failed to take TASK semaphore, status: %d\n", OS_SEM_FAILURE);
    /* Execute test */
    CFE_PSP_MemSyncTask();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Task: Failed to take ENTRY binary semaphore, status: %d\n", OS_SEM_FAILURE);
    /* Execute test */
    CFE_PSP_MemSyncTask();
    /* Verify results */
    ...
    CFE_PSP_MemSyncTask();
    /* Verify results */
    UtAssert_True(g_bCDSSyncFlag == true, UT_MEMORY_SYNC_PRINT_SCOPE "Task - 3/7: Write Failed, memory section update flag check");
    ...
    CFE_PSP_MemSyncTask();
    /* Verify results */
    UtAssert_True(g_bCDSSyncFlag == false, UT_MEMORY_SYNC_PRINT_SCOPE "Task - 4/7: Write SUCCESS, memory section update flag check");

    /* ----- Test case #5: Fail to give ENTRY semaphore----- */
    /* Set additional inputs */
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    g_bCDSSyncFlag = false;
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemTake), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemGive), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Task: Failed to give ENTRY binary semaphore, status: %d\n", OS_SEM_FAILURE);
    /* Execute test */
    CFE_PSP_MemSyncTask();
    /* Verify results */
    ...
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemGive), 1, OS_SUCCESS);
    UT_SetDeferredRetcode(UT_KEY(OS_BinSemGive), 1, OS_SEM_FAILURE);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Task: Failed to give TASK semaphore, status: %d\n", OS_SEM_FAILURE);
    /* Execute test */
    CFE_PSP_MemSyncTask();
    /* Verify results */
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "Task: Failed to delay task, status: %d\n", OS_ERROR);
    /* Execute test */
    CFE_PSP_MemSyncTask();
    /* Verify results */
...
/**********************************************************
 * void Test_CFE_PSP_CDSFilepath(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_ResetFilepath(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_VolatileDiskFilepath(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_UserReservedFilepath(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_BootRecordFilepath(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_ExceptionStorageFilepath(void); Testcases
 *********************************************************/
...
/**********************************************************
 * void Test_CFE_PSP_GenerateFilepath(void); Testcases
 *********************************************************/
void Test_CFE_PSP_GenerateFilepath(void)
{
    ...
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "GenerateFilepath: Error assembling active path, error: %d\n", -5);
    /* Execute test */
    ...
    Ut_OS_printf_Setup();
    UT_SetDefaultReturnValue(UT_KEY(snprintf), 5);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "GenerateFilepath: Error creating path\n");
    ...
    UT_ResetState(0);
    Ut_OS_printf_Setup();
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "GenerateFilepath: ERROR: %d\n", -5);
    UT_SetDeferredRetcode(UT_KEY(PCS_mkdir), 1, 0);
    UT_SetDeferredRetcode(UT_KEY(snprintf), 1, 5);
    ...
    UT_SetDefaultReturnValue(UT_KEY(OS_SymbolLookup), OS_SUCCESS);
    UT_SetDefaultReturnValue(UT_KEY(strncpy), 0);
    snprintf(cMsg, sizeof(cMsg), UT_MEMORY_SYNC_PRINT_SCOPE "GenerateFilepath: Invalid Memory Section\n");
    UT_SetDeferredRetcode(UT_KEY(PCS_mkdir), 1, 0);
    /* Execute test */
    iReturnCode = CFE_PSP_GenerateFilepath(99);
    /* Verify results */
...
void Test_CFE_PSP_FlushToFLASH(void)
{
    ...
    CFE_PSP_ReservedMemoryMap.ExceptionStoragePtr = NULL;
    ...
    /* Verify results */
    UtAssert_STUB_COUNT(PCS_open, 0);
